...
export { setSyncRepo, getSyncRepo, isSyncEnabled, SYNC_SCHEMA_VERSION } from './config.js';
...
export { syncWriteEntry, syncWriteLink, syncDeleteEntry, syncDeleteLink } from './write-through.js';
export {
  ensureRepoStructure,
  writeEntryFile,
  writeLinkFile,
